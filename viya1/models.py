...
type_project_choice = ((1, 'Villa'), (2, 'Apartment'), (2, 'Commercial'))
partner_choice  = ((1, 'Partner'), (2, 'Not a partner'))
...
project_view_choice = ((1, 'Sea'), (2,'Garden'), (3, 'Mountain'), (4,'Lake'), (5,'Mountain'), (6, 'River'), (7, '-'))
project_citizenship_choice = ((1, 'Yes'), (2, 'No'), (3, '-'))
project_residence_choice = ((1, 'Yes'), (2, 'No'), (3, '-'))
project_partnership = ((1, 'Commission'), (2, 'NoCommission'), (3, ''))
...
class OfferProject(models.Model):
    ...
    google_maps_link = models.URLField(max_length=200, unique=True, null=True, blank=True)
    google_maps_field = models.TextField(validators=[URLValidator()], null=True, blank=True)
    starting_price = models.IntegerField(null=True, blank=True)
    citizenship = models.IntegerField(choices=project_citizenship_choice, default='3')
    residence_permit = models.IntegerField(choices=project_residence_choice, default='3')
    view = models.IntegerField(choices=project_view_choice, default='7')
    #commission = models.IntegerField(null=True, blank=True)
    #kdv_vat = models.IntegerField(null=True, blank=True)
    #partnership= models.IntegerField(choices=project_view_choice, default='7')
...
class OfferProjectPhotosS(models.Model):
    photo_project = models.ImageField(upload_to='offerproject/', blank=True, null=True)
    offer_project_key = models.ForeignKey(OfferProject, on_delete=models.CASCADE, related_name='OfferProject_OfferProjectPhotosS')
    text = models.CharField(max_length=100, null=True, blank = True)

class OfferProjectVideosS(models.Model):
    offer_project_key = models.ForeignKey(OfferProject, on_delete=models.CASCADE, related_name='OfferProject_OfferProjectVideosS')
    text = models.CharField(max_length=100, null=True, blank=True)
    links = models.URLField(max_length=400, null=True, blank=True)

class OfferProjectMapsS(models.Model):
    offer_project_key = models.ForeignKey(OfferProject, on_delete=models.CASCADE, related_name='OfferProject_OfferProjectMapsS')
...
rooms_choices = ((0, '1+1'), (1, '2+1'), (2, '3+1'), (3, '4+1'), (4, '5+1'), (4, '6+1'), (4, '7+1'),
                 (3, '4+2'), (4, '5+2'), (4, '6+2'), (4, '7+2'))

offers_choices = ((0, 'Flat'), (1, 'Villa'), (2, 'Commercial'))

class OfferProjectRooms(models.Model):
    type_name = models.CharField(max_length=200, null=False, blank=False)

    def __str__(self):
        return self.type_name

class OfferProjectRoomType(models.Model):
    foreign_key = models.ForeignKey(OfferProject, on_delete=models.CASCADE, null=True, blank = True)
    type_offer = models.IntegerField(choices=offers_choices, null=True, blank = True)
    choices_rooms = models.IntegerField(choices=rooms_choices, null=True, blank=True )
    square_meter = models.CharField(max_length=100, null=True, blank = True)
